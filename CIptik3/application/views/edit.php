		...
		<form class="animation animated-item-1 form-vertical register-form" action="<?php echo base_url('indekk/update/'.$data->no); ?>" method="post">
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-ok"></i>
						<input class="m-wrap placeholder-no-fix" type="text" placeholder="NIM" name="nim" value="<?php echo $data->nim; ?>" />
					</div>
				</div>
			</div>
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-font"></i>
						<input class="m-wrap placeholder-no-fix" type="text" placeholder="Full Name" name="nama"value="<?php echo $data->nama; ?>"/>
					</div>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						...
						<textarea class="m-wrap placeholder-no-fix" style="width:30%" placeholder="City/Town" name="kota" ><?php echo $data->kota; ?></textarea>
					</div>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-user"></i>
						<input class="m-wrap placeholder-no-fix" type="text" autocomplete="off" placeholder="Elementary School" name="sd" value="<?php echo $data->sd; ?>"/>
					</div>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-user"></i>
						<input class="m-wrap placeholder-no-fix" type="text" autocomplete="off" placeholder="Junior High School" name="smp" value="<?php echo $data->smp; ?>"/>
					</div>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-user"></i>
						<input class="m-wrap placeholder-no-fix" type="text" autocomplete="off" placeholder="Senior High School" name="sma" value="<?php echo $data->sma; ?>"/>
					</div>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-user"></i>
						<input class="m-wrap placeholder-no-fix" type="text" autocomplete="off" placeholder="University" name="universitas"value="<?php echo $data->universitas; ?>"/>
					</div>
				</div>
			</div>
